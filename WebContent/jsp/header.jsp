...
<html>
				...
				<div class="col-md-3" style="padding-top:20px">
					<ol class="list-inline">
					  ...
					  <c:if test="${not empty userLogin}">
						<li>欢迎 <a href="#">${userLogin.username}</a></li>
	...
	$(function(){
		...
		var url = "/store_v7/CategoryServlet";
		var obj = {"method":"findAllcategorys"};
		//三个参数 url,方法，返回数据
		$.post(url,obj,function(data){
			 $.each(data,function(i,obj){
				var li = "<li><a href='/store_v7/ProductServlet?method=findProductsByCidWithPage&num=1&cid="+obj.cid+"'>"+obj.cname+"</a></li>";
				$("#myUL").append(li);
			}); 			
		},"json"); 	
	});
